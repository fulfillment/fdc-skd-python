...
from swagger_client.api.partners_api import PartnersApi  # noqa: E501
...
class TestPartnersApi(unittest.TestCase):
    ...
    def test_put_orders_id_ship(self):
        """Test case for put_orders_id_ship

        Ship an Order  # noqa: E501
        """
        pass

    def test_put_orders_id_status(self):
        """Test case for put_orders_id_status
