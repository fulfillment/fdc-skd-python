...
class OrdersidstatusStatus(object):
    ...
    def __init__(self, code=None):  # noqa: E501
        """OrdersidstatusStatus - a model defined in Swagger"""  # noqa: E501
        self._code = None
    ...
    @property
    def code(self):
        """Gets the code of this OrdersidstatusStatus.  # noqa: E501


        :return: The code of this OrdersidstatusStatus.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this OrdersidstatusStatus.


        :param code: The code of this OrdersidstatusStatus.  # noqa: E501
        :type: str
        """
        if code is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrdersidstatusStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrdersidstatusStatus):
            return False
