...
class PaginationV2(object):
    ...
    def __init__(self, total_pages=None, current_page=None, count=None, total=None):  # noqa: E501
        """PaginationV2 - a model defined in Swagger"""  # noqa: E501
    ...
    def total_pages(self):
        """Gets the total_pages of this PaginationV2.  # noqa: E501

        Total number of pages available to request  # noqa: E501

        :return: The total_pages of this PaginationV2.  # noqa: E501
        :rtype: int
        """
    ...
    def total_pages(self, total_pages):
        """Sets the total_pages of this PaginationV2.

        Total number of pages available to request  # noqa: E501

        :param total_pages: The total_pages of this PaginationV2.  # noqa: E501
        :type: int
        """
    ...
    def current_page(self):
        """Gets the current_page of this PaginationV2.  # noqa: E501

        Current page of the response, this will match the page paramater  # noqa: E501

        :return: The current_page of this PaginationV2.  # noqa: E501
        :rtype: int
        """
    ...
    def current_page(self, current_page):
        """Sets the current_page of this PaginationV2.

        Current page of the response, this will match the page paramater  # noqa: E501

        :param current_page: The current_page of this PaginationV2.  # noqa: E501
        :type: int
        """
    ...
    @property
    def count(self):
        """Gets the count of this PaginationV2.  # noqa: E501

        Count of records returned in response, this will be equal to or less then the limit paramater  # noqa: E501

        :return: The count of this PaginationV2.  # noqa: E501
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """Sets the count of this PaginationV2.

        Count of records returned in response, this will be equal to or less then the limit paramater  # noqa: E501

        :param count: The count of this PaginationV2.  # noqa: E501
        :type: int
        """
    ...
    @property
    def total(self):
        """Gets the total of this PaginationV2.  # noqa: E501

        Total number of records available to request  # noqa: E501

        :return: The total of this PaginationV2.  # noqa: E501
        :rtype: int
        """
        return self._total
    ...
    def total(self, total):
        """Sets the total of this PaginationV2.

        Total number of records available to request  # noqa: E501

        :param total: The total of this PaginationV2.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaginationV2, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaginationV2):
            return False
