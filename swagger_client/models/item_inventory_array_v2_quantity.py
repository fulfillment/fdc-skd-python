...
class ItemInventoryArrayV2Quantity(object):
    ...
    """
    swagger_types = {
        'total': 'ItemInventoryArrayV2QuantityTotal'
    }
    ...
    def __init__(self, total=None):  # noqa: E501
        """ItemInventoryArrayV2Quantity - a model defined in Swagger"""  # noqa: E501
        self._total = None
    ...
    @property
    def total(self):
        """Gets the total of this ItemInventoryArrayV2Quantity.  # noqa: E501


        :return: The total of this ItemInventoryArrayV2Quantity.  # noqa: E501
        :rtype: ItemInventoryArrayV2QuantityTotal
        """
        return self._total

    @total.setter
    def total(self, total):
        """Sets the total of this ItemInventoryArrayV2Quantity.


        :param total: The total of this ItemInventoryArrayV2Quantity.  # noqa: E501
        :type: ItemInventoryArrayV2QuantityTotal
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ItemInventoryArrayV2Quantity, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ItemInventoryArrayV2Quantity):
            return False
