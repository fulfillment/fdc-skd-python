...
class ReturnsItems(object):
    ...
    def __init__(self, sku=None, quantity_expected=None):  # noqa: E501
        """ReturnsItems - a model defined in Swagger"""  # noqa: E501
        self._sku = None
    ...
    @property
    def sku(self):
        """Gets the sku of this ReturnsItems.  # noqa: E501


        :return: The sku of this ReturnsItems.  # noqa: E501
        :rtype: str
        """
        return self._sku
    ...
    @sku.setter
    def sku(self, sku):
        """Sets the sku of this ReturnsItems.


        :param sku: The sku of this ReturnsItems.  # noqa: E501
        :type: str
        """
        if sku is None:
    ...
    def quantity_expected(self):
        """Gets the quantity_expected of this ReturnsItems.  # noqa: E501


        :return: The quantity_expected of this ReturnsItems.  # noqa: E501
        :rtype: int
        """
    ...
    def quantity_expected(self, quantity_expected):
        """Sets the quantity_expected of this ReturnsItems.


        :param quantity_expected: The quantity_expected of this ReturnsItems.  # noqa: E501
        :type: int
        """
        if quantity_expected is None:
            raise ValueError("Invalid value for `quantity_expected`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ReturnsItems, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReturnsItems):
            return False
