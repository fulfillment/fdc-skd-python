...
class StatusTypeSimpleV2(object):
    ...
    def __init__(self, reason=None, status=None):  # noqa: E501
        """StatusTypeSimpleV2 - a model defined in Swagger"""  # noqa: E501
        self._reason = None
        self._status = None
    ...
    @property
    def reason(self):
        """Gets the reason of this StatusTypeSimpleV2.  # noqa: E501

        Human-readable description  # noqa: E501

        :return: The reason of this StatusTypeSimpleV2.  # noqa: E501
        :rtype: str
        """
        return self._reason
    ...
    def reason(self, reason):
        """Sets the reason of this StatusTypeSimpleV2.

        Human-readable description  # noqa: E501

        :param reason: The reason of this StatusTypeSimpleV2.  # noqa: E501
        :type: str
        """
        if reason is None:
    ...
    @property
    def status(self):
        """Gets the status of this StatusTypeSimpleV2.  # noqa: E501


        :return: The status of this StatusTypeSimpleV2.  # noqa: E501
        :rtype: OrdersidstatusStatus
        """
        return self._status

    @status.setter
    def status(self, status):
        """Sets the status of this StatusTypeSimpleV2.


        :param status: The status of this StatusTypeSimpleV2.  # noqa: E501
        :type: OrdersidstatusStatus
        """
        if status is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StatusTypeSimpleV2, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StatusTypeSimpleV2):
            return False
