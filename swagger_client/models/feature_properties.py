...
class FeatureProperties(object):
    ...
    def __init__(self, name=None):  # noqa: E501
        """FeatureProperties - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this FeatureProperties.  # noqa: E501


        :return: The name of this FeatureProperties.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FeatureProperties, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeatureProperties):
            return False
