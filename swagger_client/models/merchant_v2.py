...
class MerchantV2(object):
    ...
    def __init__(self, id=None, name=None):  # noqa: E501
        """MerchantV2 - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
    ...
    @property
    def id(self):
        """Gets the id of this MerchantV2.  # noqa: E501


        :return: The id of this MerchantV2.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this MerchantV2.


        :param id: The id of this MerchantV2.  # noqa: E501
        :type: int
        """
        if id is None:
    ...
    @property
    def name(self):
        """Gets the name of this MerchantV2.  # noqa: E501

        Merchant Company Name  # noqa: E501

        :return: The name of this MerchantV2.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this MerchantV2.

        Merchant Company Name  # noqa: E501

        :param name: The name of this MerchantV2.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MerchantV2):
            return False
