...
class StatusTypeV2Stage(object):
    ...
    def __init__(self, name=None, code=None):  # noqa: E501
        """StatusTypeV2Stage - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._code = None
    ...
    @property
    def name(self):
        """Gets the name of this StatusTypeV2Stage.  # noqa: E501


        :return: The name of this StatusTypeV2Stage.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this StatusTypeV2Stage.


        :param name: The name of this StatusTypeV2Stage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def code(self):
        """Gets the code of this StatusTypeV2Stage.  # noqa: E501


        :return: The code of this StatusTypeV2Stage.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this StatusTypeV2Stage.


        :param code: The code of this StatusTypeV2Stage.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StatusTypeV2Stage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StatusTypeV2Stage):
            return False
