...
class OrdersItems(object):
    ...
    def __init__(self, quantity=None, sku=None, declared_value=None):  # noqa: E501
        """OrdersItems - a model defined in Swagger"""  # noqa: E501
        self._quantity = None
        self._sku = None
    ...
    @property
    def quantity(self):
        """Gets the quantity of this OrdersItems.  # noqa: E501


        :return: The quantity of this OrdersItems.  # noqa: E501
        :rtype: int
        """
    ...
    def quantity(self, quantity):
        """Sets the quantity of this OrdersItems.


        :param quantity: The quantity of this OrdersItems.  # noqa: E501
        :type: int
        """
        if quantity is None:
    ...
    @property
    def sku(self):
        """Gets the sku of this OrdersItems.  # noqa: E501


        :return: The sku of this OrdersItems.  # noqa: E501
        :rtype: str
        """
        return self._sku
    ...
    @sku.setter
    def sku(self, sku):
        """Sets the sku of this OrdersItems.


        :param sku: The sku of this OrdersItems.  # noqa: E501
        :type: str
        """
        if sku is None:
    ...
    def declared_value(self):
        """Gets the declared_value of this OrdersItems.  # noqa: E501

        Using USD, a per unit value of a single SKU. If your declaring a kit this is the sum total for a single kit. In both scenarios we will multiply the `declaredValue` against the `quantity` for customs declaration.  # noqa: E501

        :return: The declared_value of this OrdersItems.  # noqa: E501
        :rtype: str
        """
    ...
    def declared_value(self, declared_value):
        """Sets the declared_value of this OrdersItems.

        Using USD, a per unit value of a single SKU. If your declaring a kit this is the sum total for a single kit. In both scenarios we will multiply the `declaredValue` against the `quantity` for customs declaration.  # noqa: E501

        :param declared_value: The declared_value of this OrdersItems.  # noqa: E501
        :type: str
        """
        if declared_value is None:
            raise ValueError("Invalid value for `declared_value`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrdersItems, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrdersItems):
            return False
