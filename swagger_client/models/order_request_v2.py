...
class OrderRequestV2(object):
    ...
    swagger_types = {
        ...
        'shipping_method': 'str',
        'recipient': 'ConsigneeNewV2',
        'items': 'list[OrdersItems]',
    ...
    def __init__(self, merchant_id=None, merchant_order_id=None, shipping_method=None, recipient=None, items=None, warehouse=None, integrator=None, notes=None):  # noqa: E501
        """OrderRequestV2 - a model defined in Swagger"""  # noqa: E501
    ...
    def merchant_id(self):
        """Gets the merchant_id of this OrderRequestV2.  # noqa: E501

        Necessary if you have a multitenancy account, otherwise we will associate the order with your account  # noqa: E501

        :return: The merchant_id of this OrderRequestV2.  # noqa: E501
        :rtype: int
        """
    ...
    def merchant_id(self, merchant_id):
        """Sets the merchant_id of this OrderRequestV2.

        Necessary if you have a multitenancy account, otherwise we will associate the order with your account  # noqa: E501

        :param merchant_id: The merchant_id of this OrderRequestV2.  # noqa: E501
        :type: int
        """
    ...
    def merchant_order_id(self):
        """Gets the merchant_order_id of this OrderRequestV2.  # noqa: E501

        Unique ID provided by the merchant  # noqa: E501

        :return: The merchant_order_id of this OrderRequestV2.  # noqa: E501
        :rtype: str
        """
    ...
    def merchant_order_id(self, merchant_order_id):
        """Sets the merchant_order_id of this OrderRequestV2.

        Unique ID provided by the merchant  # noqa: E501

        :param merchant_order_id: The merchant_order_id of this OrderRequestV2.  # noqa: E501
        :type: str
        """
    ...
    def shipping_method(self):
        """Gets the shipping_method of this OrderRequestV2.  # noqa: E501

        Custom for you, it will be mapped to an actual method within the OMS UI  # noqa: E501

        :return: The shipping_method of this OrderRequestV2.  # noqa: E501
        :rtype: str
        """
    ...
    def shipping_method(self, shipping_method):
        """Sets the shipping_method of this OrderRequestV2.

        Custom for you, it will be mapped to an actual method within the OMS UI  # noqa: E501

        :param shipping_method: The shipping_method of this OrderRequestV2.  # noqa: E501
        :type: str
        """
    ...
    @property
    def recipient(self):
        """Gets the recipient of this OrderRequestV2.  # noqa: E501


        :return: The recipient of this OrderRequestV2.  # noqa: E501
        :rtype: ConsigneeNewV2
        """
        return self._recipient

    @recipient.setter
    def recipient(self, recipient):
        """Sets the recipient of this OrderRequestV2.


        :param recipient: The recipient of this OrderRequestV2.  # noqa: E501
        :type: ConsigneeNewV2
        """
    ...
    @property
    def items(self):
        """Gets the items of this OrderRequestV2.  # noqa: E501


        :return: The items of this OrderRequestV2.  # noqa: E501
        :rtype: list[OrdersItems]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this OrderRequestV2.


        :param items: The items of this OrderRequestV2.  # noqa: E501
        :type: list[OrdersItems]
        """
        if items is None:
    ...
    @property
    def warehouse(self):
        """Gets the warehouse of this OrderRequestV2.  # noqa: E501


        :return: The warehouse of this OrderRequestV2.  # noqa: E501
        :rtype: OrdersWarehouse
        """
        return self._warehouse

    @warehouse.setter
    def warehouse(self, warehouse):
        """Sets the warehouse of this OrderRequestV2.


        :param warehouse: The warehouse of this OrderRequestV2.  # noqa: E501
        :type: OrdersWarehouse
        """
    ...
    @property
    def integrator(self):
        """Gets the integrator of this OrderRequestV2.  # noqa: E501

        Use of this property requires special permission and must be discussed with your account executive; values are restricted while custom values need to be accepted by your AE.  # noqa: E501

        :return: The integrator of this OrderRequestV2.  # noqa: E501
        :rtype: str
        """
    ...
    @property
    def notes(self):
        """Gets the notes of this OrderRequestV2.  # noqa: E501


        :return: The notes of this OrderRequestV2.  # noqa: E501
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this OrderRequestV2.


        :param notes: The notes of this OrderRequestV2.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrderRequestV2, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrderRequestV2):
            return False
