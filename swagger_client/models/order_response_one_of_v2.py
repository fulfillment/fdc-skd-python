...
class OrderResponseOneOfV2(object):
    ...
    def __init__(self):  # noqa: E501
        """OrderResponseOneOfV2 - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrderResponseOneOfV2, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrderResponseOneOfV2):
            return False
