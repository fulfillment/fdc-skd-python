...
class ReturnsArrayV2Status(object):
    ...
    def __init__(self, id=None, title=None):  # noqa: E501
        """ReturnsArrayV2Status - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._title = None
    ...
    @property
    def id(self):
        """Gets the id of this ReturnsArrayV2Status.  # noqa: E501


        :return: The id of this ReturnsArrayV2Status.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ReturnsArrayV2Status.


        :param id: The id of this ReturnsArrayV2Status.  # noqa: E501
        :type: int
        """
        if id is None:
    ...
    @property
    def title(self):
        """Gets the title of this ReturnsArrayV2Status.  # noqa: E501


        :return: The title of this ReturnsArrayV2Status.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this ReturnsArrayV2Status.


        :param title: The title of this ReturnsArrayV2Status.  # noqa: E501
        :type: str
        """
        if title is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ReturnsArrayV2Status, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReturnsArrayV2Status):
            return False
