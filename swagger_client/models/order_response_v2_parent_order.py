...
class OrderResponseV2ParentOrder(object):
    ...
    def __init__(self, id=None):  # noqa: E501
        """OrderResponseV2ParentOrder - a model defined in Swagger"""  # noqa: E501
        self._id = None
    ...
    @property
    def id(self):
        """Gets the id of this OrderResponseV2ParentOrder.  # noqa: E501

        Reference to parent `id` if order was grouped  # noqa: E501

        :return: The id of this OrderResponseV2ParentOrder.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this OrderResponseV2ParentOrder.

        Reference to parent `id` if order was grouped  # noqa: E501

        :param id: The id of this OrderResponseV2ParentOrder.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrderResponseV2ParentOrder, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrderResponseV2ParentOrder):
            return False
