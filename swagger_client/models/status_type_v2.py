...
class StatusTypeV2(object):
    ...
    swagger_types = {
        'id': 'int',
        'is_closed': 'bool',
        'action_required_by': 'StatusTypeV2ActionRequiredBy',
        'stage': 'StatusTypeV2Stage',
        'state': 'StatusTypeV2Stage',
        'detail': 'str',
        'reason': 'str',
        'name': 'str',
        'detail_code': 'str',
    ...
    def __init__(self, id=None, is_closed=None, action_required_by=None, stage=None, state=None, detail=None, reason=None, name=None, detail_code=None, code=None):  # noqa: E501
        """StatusTypeV2 - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._is_closed = None
        self._action_required_by = None
        self._stage = None
        self._state = None
        self._detail = None
        self._reason = None
        ...
        if action_required_by is not None:
            self.action_required_by = action_required_by
        self.stage = stage
        self.state = state
    ...
    @property
    def id(self):
        """Gets the id of this StatusTypeV2.  # noqa: E501

        Depricated, use code instead  # noqa: E501

        :return: The id of this StatusTypeV2.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this StatusTypeV2.

        Depricated, use code instead  # noqa: E501

        :param id: The id of this StatusTypeV2.  # noqa: E501
        :type: int
        """
    ...
    @property
    def is_closed(self):
        """Gets the is_closed of this StatusTypeV2.  # noqa: E501

        Depricated, does this status event close the order  # noqa: E501

        :return: The is_closed of this StatusTypeV2.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_closed(self, is_closed):
        """Sets the is_closed of this StatusTypeV2.

        Depricated, does this status event close the order  # noqa: E501

        :param is_closed: The is_closed of this StatusTypeV2.  # noqa: E501
        :type: bool
        """
    ...
    def action_required_by(self):
        """Gets the action_required_by of this StatusTypeV2.  # noqa: E501


        :return: The action_required_by of this StatusTypeV2.  # noqa: E501
        :rtype: StatusTypeV2ActionRequiredBy
        """
        return self._action_required_by

    @action_required_by.setter
    def action_required_by(self, action_required_by):
        """Sets the action_required_by of this StatusTypeV2.


        :param action_required_by: The action_required_by of this StatusTypeV2.  # noqa: E501
        :type: StatusTypeV2ActionRequiredBy
        """

        self._action_required_by = action_required_by

    @property
    def stage(self):
        """Gets the stage of this StatusTypeV2.  # noqa: E501


        :return: The stage of this StatusTypeV2.  # noqa: E501
        :rtype: StatusTypeV2Stage
        """
        return self._stage

    @stage.setter
    def stage(self, stage):
        """Sets the stage of this StatusTypeV2.


        :param stage: The stage of this StatusTypeV2.  # noqa: E501
        :type: StatusTypeV2Stage
        """
        if stage is None:
    ...
    @property
    def state(self):
        """Gets the state of this StatusTypeV2.  # noqa: E501


        :return: The state of this StatusTypeV2.  # noqa: E501
        :rtype: StatusTypeV2Stage
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this StatusTypeV2.


        :param state: The state of this StatusTypeV2.  # noqa: E501
        :type: StatusTypeV2Stage
        """
        if state is None:
    ...
    @property
    def detail(self):
        """Gets the detail of this StatusTypeV2.  # noqa: E501


        :return: The detail of this StatusTypeV2.  # noqa: E501
        :rtype: str
        """
        return self._detail
    ...
    def detail(self, detail):
        """Sets the detail of this StatusTypeV2.


        :param detail: The detail of this StatusTypeV2.  # noqa: E501
        :type: str
        """
    ...
    @property
    def reason(self):
        """Gets the reason of this StatusTypeV2.  # noqa: E501

        Depricated  # noqa: E501

        :return: The reason of this StatusTypeV2.  # noqa: E501
        :rtype: str
        """
        return self._reason
    ...
    def reason(self, reason):
        """Sets the reason of this StatusTypeV2.

        Depricated  # noqa: E501

        :param reason: The reason of this StatusTypeV2.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this StatusTypeV2.  # noqa: E501

        Depricated, use stage/state instead  # noqa: E501

        :return: The name of this StatusTypeV2.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this StatusTypeV2.

        Depricated, use stage/state instead  # noqa: E501

        :param name: The name of this StatusTypeV2.  # noqa: E501
        :type: str
        """
    ...
    def detail_code(self):
        """Gets the detail_code of this StatusTypeV2.  # noqa: E501


        :return: The detail_code of this StatusTypeV2.  # noqa: E501
        :rtype: str
        """
    ...
    def detail_code(self, detail_code):
        """Sets the detail_code of this StatusTypeV2.


        :param detail_code: The detail_code of this StatusTypeV2.  # noqa: E501
        :type: str
        """
        if detail_code is None:
            raise ValueError("Invalid value for `detail_code`, must not be `None`")  # noqa: E501

        self._detail_code = detail_code

    @property
    def code(self):
        """Gets the code of this StatusTypeV2.  # noqa: E501

        Code, see [status codes](#section/Getting-Started/Status-Codes)  # noqa: E501

        :return: The code of this StatusTypeV2.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this StatusTypeV2.

        Code, see [status codes](#section/Getting-Started/Status-Codes)  # noqa: E501

        :param code: The code of this StatusTypeV2.  # noqa: E501
        :type: str
        """
        if code is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StatusTypeV2, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StatusTypeV2):
            return False
