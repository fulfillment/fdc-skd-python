...
class ItemInventoryArrayV2QuantityTotal(object):
    ...
    def __init__(self, available_to_promise=None):  # noqa: E501
        """ItemInventoryArrayV2QuantityTotal - a model defined in Swagger"""  # noqa: E501
        self._available_to_promise = None
        self.discriminator = None
        if available_to_promise is not None:
            self.available_to_promise = available_to_promise

    @property
    def available_to_promise(self):
        """Gets the available_to_promise of this ItemInventoryArrayV2QuantityTotal.  # noqa: E501

        Number of items that are available to be used in an order  # noqa: E501

        :return: The available_to_promise of this ItemInventoryArrayV2QuantityTotal.  # noqa: E501
        :rtype: int
        """
        return self._available_to_promise

    @available_to_promise.setter
    def available_to_promise(self, available_to_promise):
        """Sets the available_to_promise of this ItemInventoryArrayV2QuantityTotal.

        Number of items that are available to be used in an order  # noqa: E501

        :param available_to_promise: The available_to_promise of this ItemInventoryArrayV2QuantityTotal.  # noqa: E501
        :type: int
        """

        self._available_to_promise = available_to_promise
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ItemInventoryArrayV2QuantityTotal, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ItemInventoryArrayV2QuantityTotal):
            return False
