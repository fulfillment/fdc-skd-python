...
class ItemInventoryArrayV2Item(object):
    ...
    def __init__(self, id=None, sku_reference=None):  # noqa: E501
        """ItemInventoryArrayV2Item - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._sku_reference = None
        self.discriminator = None
        if id is not None:
            self.id = id
        if sku_reference is not None:
            self.sku_reference = sku_reference

    @property
    def id(self):
        """Gets the id of this ItemInventoryArrayV2Item.  # noqa: E501

        FDC ID for this Item  # noqa: E501

        :return: The id of this ItemInventoryArrayV2Item.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ItemInventoryArrayV2Item.

        FDC ID for this Item  # noqa: E501

        :param id: The id of this ItemInventoryArrayV2Item.  # noqa: E501
        :type: int
        """
    ...
    @property
    def sku_reference(self):
        """Gets the sku_reference of this ItemInventoryArrayV2Item.  # noqa: E501

        Sku reference name for this item  # noqa: E501

        :return: The sku_reference of this ItemInventoryArrayV2Item.  # noqa: E501
        :rtype: str
        """
        return self._sku_reference

    @sku_reference.setter
    def sku_reference(self, sku_reference):
        """Sets the sku_reference of this ItemInventoryArrayV2Item.

        Sku reference name for this item  # noqa: E501

        :param sku_reference: The sku_reference of this ItemInventoryArrayV2Item.  # noqa: E501
        :type: str
        """

        self._sku_reference = sku_reference
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ItemInventoryArrayV2Item, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ItemInventoryArrayV2Item):
            return False
