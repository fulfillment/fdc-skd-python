...
class ItemInventoryArrayV2Merchant(object):
    ...
    def __init__(self, name=None):  # noqa: E501
        """ItemInventoryArrayV2Merchant - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this ItemInventoryArrayV2Merchant.  # noqa: E501

        Merchants name for this item  # noqa: E501

        :return: The name of this ItemInventoryArrayV2Merchant.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ItemInventoryArrayV2Merchant.

        Merchants name for this item  # noqa: E501

        :param name: The name of this ItemInventoryArrayV2Merchant.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ItemInventoryArrayV2Merchant, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ItemInventoryArrayV2Merchant):
            return False
