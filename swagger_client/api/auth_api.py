...
class AuthApi(object):
    ...
    def post_oauth_access_token(self, body, **kwargs):  # noqa: E501
        """Generate an Access Token  # noqa: E501

        By default tokens are valid for 7 days while refresh tokens are valid for 30 days. If your `grant_type` is \"password\" include the `username` and `password`, if however your `grant_type` is \"refresh_token\" the username/password are not required, instead set the `refresh_token`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_oauth_access_token(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AccessTokenRequestV2 body: Get an access token (required)
        :return: AccessTokenResponseV2
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_oauth_access_token_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_oauth_access_token_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def post_oauth_access_token_with_http_info(self, body, **kwargs):  # noqa: E501
        """Generate an Access Token  # noqa: E501

        By default tokens are valid for 7 days while refresh tokens are valid for 30 days. If your `grant_type` is \"password\" include the `username` and `password`, if however your `grant_type` is \"refresh_token\" the username/password are not required, instead set the `refresh_token`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_oauth_access_token_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method post_oauth_access_token" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_oauth_access_token`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='AccessTokenResponseV2',  # noqa: E501
