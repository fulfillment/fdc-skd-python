...
class ReturnsApi(object):
    ...
    def get_returns(self, from_date, to_date, **kwargs):  # noqa: E501
        """List Returns  # noqa: E501

        Retrieves summary return activity during the queried timespan. Although return knowledge can be learned from `GET /orders/{id}` it can take an unknown amount of time for an order that is refused or undeliverable to return to an FDC facility. Instead we recommend regularly querying this API.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_returns(from_date, to_date, async_req=True)
        >>> result = thread.get()
        ...
        :return: ReturnsArrayV2
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_returns_with_http_info(from_date, to_date, **kwargs)  # noqa: E501
        else:
            (data) = self.get_returns_with_http_info(from_date, to_date, **kwargs)  # noqa: E501
            return data

    def get_returns_with_http_info(self, from_date, to_date, **kwargs):  # noqa: E501
        """List Returns  # noqa: E501

        Retrieves summary return activity during the queried timespan. Although return knowledge can be learned from `GET /orders/{id}` it can take an unknown amount of time for an order that is refused or undeliverable to return to an FDC facility. Instead we recommend regularly querying this API.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_returns_with_http_info(from_date, to_date, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['from_date', 'to_date', 'page', 'limit']  # noqa: E501
        ...
        if ('from_date' not in params or
            ...
            raise ValueError("Missing the required parameter `from_date` when calling `get_returns`")  # noqa: E501
        # verify the required parameter 'to_date' is set
        if ('to_date' not in params or
                params['to_date'] is None):
            raise ValueError("Missing the required parameter `to_date` when calling `get_returns`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ReturnsArrayV2',  # noqa: E501
    ...
    def put_returns(self, body, **kwargs):  # noqa: E501
        """Inform us of an RMA  # noqa: E501

        Inform FDC of an expected return.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_returns(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param RmaRequestV2 body: RMA (required)
        :return: RmaResponseV2
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_returns_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.put_returns_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def put_returns_with_http_info(self, body, **kwargs):  # noqa: E501
        """Inform us of an RMA  # noqa: E501

        Inform FDC of an expected return.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_returns_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_returns`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='RmaResponseV2',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
