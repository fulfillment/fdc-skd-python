...
class TrackingApi(object):
    ...
    def get_track(self, **kwargs):  # noqa: E501
        """Tracking  # noqa: E501

        Get uniformed tracking events for any package, this response is carrier independent. Please note, an API Key is required for throttling purposes, please contact your success manager for details.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_track(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str tracking_number:
        ...
        if kwargs.get('async_req'):
            return self.get_track_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_track_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_track_with_http_info(self, **kwargs):  # noqa: E501
        """Tracking  # noqa: E501

        Get uniformed tracking events for any package, this response is carrier independent. Please note, an API Key is required for throttling purposes, please contact your success manager for details.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_track_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'tracking_number' in params:
            query_params.append(('trackingNumber', params['tracking_number']))  # noqa: E501
