...
class PartnersApi(object):
    ...
    def put_orders_id_ship(self, body, id, **kwargs):  # noqa: E501
        """Ship an Order  # noqa: E501

        Note, this API is used to update orders and is reserved for our shipping partners.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_orders_id_ship(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param OrderShipV2 body: Shipping Details (required)
        :param int id: The FDC order Id (required)
        ...
        if kwargs.get('async_req'):
            return self.put_orders_id_ship_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.put_orders_id_ship_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def put_orders_id_ship_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Ship an Order  # noqa: E501

        Note, this API is used to update orders and is reserved for our shipping partners.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_orders_id_ship_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method put_orders_id_ship" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_orders_id_ship`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `put_orders_id_ship`")  # noqa: E501
    ...
    def put_orders_id_status(self, body, id, **kwargs):  # noqa: E501
        """Update Order Status  # noqa: E501

        Note, this API is used to update orders and is reserved for our shipping partners.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_orders_id_status(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param StatusTypeSimpleV2 body: New status event (required)
        :param int id: The FDC order Id (required)
        :return: Paths1orderspostresponses201contentapplication1jsonschema
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_orders_id_status_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.put_orders_id_status_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def put_orders_id_status_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Update Order Status  # noqa: E501

        Note, this API is used to update orders and is reserved for our shipping partners.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_orders_id_status_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_orders_id_status" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_orders_id_status`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `put_orders_id_status`")  # noqa: E501
