...
class InventoryApi(object):
    ...
    def get_inventory(self, **kwargs):  # noqa: E501
        """List of Item Inventories  # noqa: E501

        Retrieve inventory for one or more items. This API requires elevated permissions, please speak to your success manager.  # noqa: E501
        ...
        :param list[str] external_sku_names: A CSV of sku reference names, 'skuName1' or 'skuName1,skuName2,skuName3'
    ...
    def get_inventory_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['page', 'limit', 'merchant_ids', 'external_sku_names']  # noqa: E501
        ...
        if 'external_sku_names' in params:
            query_params.append(('externalSkuNames', params['external_sku_names']))  # noqa: E501
            collection_formats['externalSkuNames'] = 'csv'  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ItemInventoryArrayV2',  # noqa: E501
